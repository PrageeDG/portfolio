      ...
      <div className="mt-8 grid gap-6 lg:grid-cols-2">
        <motion.div initial={{ opacity: 0, y: 18 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="glass-card p-6">
          ...
          <div className="mt-5 space-y-3 text-sm">
            ...
            <a href={portfolio.github} target="_blank" rel="noreferrer" className="glass-card flex items-center gap-2 p-3 text-mutedText hover:text-softBlue"><Github size={16} />github.com/prageeth</a>
          </div>
        </motion.div>
