        ...
        >
          ...
          <div className="relative mb-4 overflow-hidden rounded-xl border border-sera">
            <Image
              ...
              className="h-[360px] w-full object-cover sm:h-[480px] lg:h-[520px]"
            />
            <div className="absolute inset-0 bg-gradient-to-t from-darkBg/30 to-transparent" />
          </div>

          <div className="mt-4 grid grid-cols-1 gap-3 sm:grid-cols-3">
            <div className="glass-card p-3 sm:animate-float">
            ...
            <div className="glass-card p-3 sm:animate-float sm:[animation-delay:0.2s]">
            ...
            <div className="glass-card p-3 sm:animate-float sm:[animation-delay:0.4s]">
